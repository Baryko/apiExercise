...
const modifyButtonAvailiability = (e) => {
...
const sortTable = (e, i) => {
    ...
    const optionName = e.target.options[optionIndex].getAttribute("name");
...
const getData = (e) => {
    ...
    const options = {
        headers: {
            Authorization: 'Bearer ' + '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',
            Accept: 'application/vnd.github+json'
        }
    };

    const url = `https://api.github.com/search/repositories?q=${value}&page=${page}&per_page=10&sort=${sort}&order=${order}`;
...
textInput.addEventListener('keyup', (e) => modifyButtonAvailiability(e));
sortElement.addEventListener('change', (e) => sortTable(e));
